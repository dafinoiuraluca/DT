    ...
    methods: {
        ...
        encode: function(bits){
            ...
            if(bits.length === 4) {
                ...
                var c0=this.parity(c1+c2+parseInt(bits[0].data)+c4+parseInt(bits[1].data)+parseInt(bits[2].data)+parseInt(bits[3].data)); // bitul de paritate
                ...
                var c0=this.parity(c1+c2+parseInt(bits[0].data)+c4+parseInt(bits[1].data)+parseInt(bits[2].data)+parseInt(bits[3].data)+c8+parseInt(bits[4].data)+parseInt(bits[5].data)+parseInt(bits[6].data)+parseInt(bits[7].data)); // bitul de paritate
